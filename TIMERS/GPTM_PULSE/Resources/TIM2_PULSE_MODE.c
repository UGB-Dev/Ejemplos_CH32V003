...
void Pulse_Mod_Init(void){
    ...
    //GPIOD -> CFGLR &= ~(GPIO_CFGLR_CNF3 | GPIO_CFGLR_MODE1); // Borra configuraciones iniciales
    //GPIOD -> CFGLR |= GPIO_CFGLR_CNF3_0; // Se configura el pin PD3 como entrada flotante

    /* CONFIGURACION DEL PIN PD4 */
    GPIOD -> CFGLR &= ~(GPIO_CFGLR_MODE4 | GPIO_CFGLR_CNF4); // Borra configuraciones iniciales
    GPIOD -> CFGLR |= GPIO_CFGLR_MODE4 | GPIO_CFGLR_CNF4_1; // PD4 como salida a 30 MHz push-pull multiplexada
