 ...
 * Version            : V1.0.0
 * Date               : 2023/12/25
 * Description        : GPTM; Se configuran los registros asociados del timer 2 para
 *                      usar el modo encoder en los pines PD3(CH2) y PD4(CH1) el cual
...
int main(void){
    ...
    while(1){
        CONTEO = TIM2 -> CNT ; // Se captura el valor del registro CNT
