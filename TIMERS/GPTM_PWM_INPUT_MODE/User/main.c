 ...
 * Version            : V1.0.0
 * Date               : 2023/12/25
 * Description        : GPTM; Se ajustan los registros asociados al Timer 2 para trabajar
 *                      en modo de captura PWM en los pines PD3 y PD4, los valores de captura
...
int main(void){
    ...
    while(1){
        ...
        Value_CH1CVR = TIM2 -> CH1CVR;
        Value_CH2CVR = TIM2 -> CH2CVR;
